	...
	<main id="tp_content" role="main">
		<div id="primary" class="content-area">
			<div class="page-header">
				<?php if ( have_posts() ) : ?>
					<h1 class="page-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s', 'ai-automation' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
				<?php else : ?>
					<h1 class="page-title"><?php echo esc_html(get_theme_mod('ai_automation_edit_no_result_title',__('Nothing Found','ai-automation')));?></h1>
				<?php endif; ?>
			</div>		
			<?php
	        $ai_automation_sidebar_layout = get_theme_mod( 'ai_automation_sidebar_post_layout','right');
		          	...
		          	<div class="col-lg-8 col-md-8">
			            ...
			            <?php if ( have_posts() ) :
							...
							endwhile; // End of the loop.
								...
								<p><?php echo esc_html(get_theme_mod('ai_automation_edit_no_result_text',__('Sorry, but nothing matched your search terms. Please try again with some different keywords.','ai-automation')));?></p>
								<?php
									get_search_form();
		    ...
		    <?php }else if($ai_automation_sidebar_layout == 'three-column'){ ?>
		        <div class="row m-0">
		    ...
		    <?php }else if($ai_automation_sidebar_layout == 'four-column'){ ?>
		        <div class="row m-0">
		    ...
		    <?php }else if($ai_automation_sidebar_layout == 'grid'){ ?>
		        <div class="row m-0">
