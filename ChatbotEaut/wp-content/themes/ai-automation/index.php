...
<div class="box-image-page">
	...
	<div class="box-text">
		<h2>
			<?php
			$ai_automation_blog_title = get_theme_mod('ai_automation_edit_blog_page_title', __('Home', 'ai-automation'));
			echo esc_html($ai_automation_blog_title);
			?>
		</h2>
		<?php
		$ai_automation_edit_blog_page_description = get_theme_mod('ai_automation_edit_blog_page_description', '');

		if (!empty($ai_automation_edit_blog_page_description)) : ?>
			<p class="blog-description"><?php echo esc_html($ai_automation_edit_blog_page_description); ?></p>
		<?php endif; ?>
	</div>
</div>
